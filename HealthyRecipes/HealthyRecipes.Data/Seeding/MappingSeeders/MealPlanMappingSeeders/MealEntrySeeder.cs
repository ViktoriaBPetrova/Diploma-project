...
namespace HealthyRecipes.Data.Seeding.MealPlanSeeders
{
    ...
    public class MealEntrySeeder
    {
        ...
        {
            // Updated seeding date to March 28, 2026 - these are "logged" entries from the past
            ...
            List<MealEntry> mealEntries = new List<MealEntry>()
            {
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-10).AddHours(7).AddMinutes(30), // March 18, 7:30 AM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-10).AddHours(13), // March 18, 1 PM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-10).AddHours(19), // March 18, 7 PM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-9).AddHours(7).AddMinutes(15), // March 19, 7:15 AM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-9).AddHours(12).AddMinutes(45), // March 19, 12:45 PM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-8).AddHours(7).AddMinutes(45), // March 20, 7:45 AM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-8).AddHours(19), // March 20, 7 PM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-7).AddHours(7).AddMinutes(30), // March 21, 7:30 AM
                    IsPublic = true,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-7).AddHours(12).AddMinutes(30), // March 21, 12:30 PM
                    IsPublic = true,
                    CreatedAt = seedingDate.AddDays(-7).AddHours(13),
                    UpdatedAt = seedingDate.AddDays(-7).AddHours(13)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-6).AddHours(7).AddMinutes(45), // March 22, 7:45 AM
                    IsPublic = true,
                    CreatedAt = seedingDate.AddDays(-6).AddHours(8).AddMinutes(15),
                    UpdatedAt = seedingDate.AddDays(-6).AddHours(8).AddMinutes(15)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-6).AddHours(13), // March 22, 1 PM
                    IsPublic = true,
                    CreatedAt = seedingDate.AddDays(-6).AddHours(13).AddMinutes(30),
                    UpdatedAt = seedingDate.AddDays(-6).AddHours(13).AddMinutes(30)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-6).AddHours(19).AddMinutes(30), // March 22, 7:30 PM
                    IsPublic = true,
                    CreatedAt = seedingDate.AddDays(-6).AddHours(20),
                    UpdatedAt = seedingDate.AddDays(-6).AddHours(20)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-8).AddHours(6).AddMinutes(30), // March 20, 6:30 AM
                    IsPublic = false,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-8).AddHours(11).AddMinutes(30), // March 20, 11:30 AM
                    IsPublic = false,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-7).AddHours(6).AddMinutes(15), // March 21, 6:15 AM
                    IsPublic = false,
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-2).AddHours(8).AddMinutes(15), // March 26, 8:15 AM
                    IsPublic = false,
                    CreatedAt = seedingDate.AddDays(-2).AddHours(8).AddMinutes(45),
                    UpdatedAt = seedingDate.AddDays(-2).AddHours(8).AddMinutes(45)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-2).AddHours(12).AddMinutes(30), // March 26, 12:30 PM
                    IsPublic = false,
                    CreatedAt = seedingDate.AddDays(-2).AddHours(13),
                    UpdatedAt = seedingDate.AddDays(-2).AddHours(13)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-1).AddHours(8), // March 27, 8 AM
                    IsPublic = false,
                    CreatedAt = seedingDate.AddDays(-1).AddHours(8).AddMinutes(30),
                    UpdatedAt = seedingDate.AddDays(-1).AddHours(8).AddMinutes(30)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-2).AddHours(7).AddMinutes(45), // March 26, 7:45 AM
                    IsPublic = false,
                    CreatedAt = seedingDate.AddDays(-2).AddHours(8).AddMinutes(15),
                    UpdatedAt = seedingDate.AddDays(-2).AddHours(8).AddMinutes(15)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-2).AddHours(12).AddMinutes(15), // March 26, 12:15 PM
                    IsPublic = false,
                    CreatedAt = seedingDate.AddDays(-2).AddHours(12).AddMinutes(45),
                    UpdatedAt = seedingDate.AddDays(-2).AddHours(12).AddMinutes(45)
                },
                ...
                new MealEntry
                {
                    ...
                    ConsumedAt = seedingDate.AddDays(-1).AddHours(7).AddMinutes(30), // March 27, 7:30 AM
                    IsPublic = false,
                    CreatedAt = seedingDate.AddDays(-1).AddHours(8),
                    UpdatedAt = seedingDate.AddDays(-1).AddHours(8)
                }
            };
