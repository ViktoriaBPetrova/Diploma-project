    ...
    public partial class Seeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b4f6d2c1-3a8e-4b9c-9d0f-5a6b7c8d9e02"), 0, "System administrator", 2000f, 250f, "43b9fcd1-5bde-4848-aacb-59d8b3ca80d0", new DateTime(2025, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "admin@email.com", true, 70f, "Anna", 167f, "Stone", false, null, "ADMIN@EMAIL.COM", "ADMIN@EMAIL.COM", "AQAAAAIAAYagAAAAENpfAEZCOAiaN8Uyuugs2FFoWUANb9P3dGCgOD3bnfKxLfNPjfaqzo4zuaGRXmVc4g==", "0897123456", true, 100f, "d6c5b4a3-2f1e-0d9c-8b7a-6e5f4d3c2b1a", false, new DateTime(2025, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@email.com", 60f },
                    { new Guid("e8a7c3b4-1f5d-4a6c-9b2e-7c3d5f8a9b01"), 0, "Fitness enthusiast", 2500f, 300f, "21629e20-4bd6-4212-94a4-2279d0068102", new DateTime(2025, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, "user@email.com", true, 60f, "John", 180f, "Doe", false, null, "USER@EMAIL.COM", "USER@EMAIL.COM", "AQAAAAIAAYagAAAAEFrIDCf7GJMWujVwG6dvRq5bmdjZ4L+6qvizLsO7xQ9HJ1i79QFs36SSBITWVV6kig==", "0897123456", true, 150f, "a1b2c3d4-5e6f-7a8b-9c0d-1e2f3a4b5c6d", false, new DateTime(2025, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "user@email.com", 80f }
                });
